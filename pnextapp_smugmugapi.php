...
class MediashareSmugMugAlbum extends MediashareBaseAlbum
{
    ...
    function convertImage(&$image)
    {
        return array(
            ...
            'title' => mb_convert_encoding(empty($image['Caption']) ? $image['Key'] : $image['Caption'], __('ISO-8859-1', $dom), 'UTF-8'),
            'keywordsArray' => array(),
            'hasKeywords' => false,
            'keywords' => $image['Keywords'],
            'description' => '',
            'caption' => mb_convert_encoding($image['Caption'], __('ISO-8859-1', $dom), 'UTF-8'),
            'captionLong' => mb_convert_encoding($image['Caption'], __('ISO-8859-1', $dom), 'UTF-8'),
