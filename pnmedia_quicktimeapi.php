<?php
// $Id: pnmedia_quicktimeapi.php,v 1.4 2006/03/26 18:01:55 jornlind Exp $
// =======================================================================
...
class mediashare_quicktimeHandler
{
  ...
  {
    return array( 
      array('mimeType' => 'video/quicktime', 'fileType' => 'mov',
            'foundMimeType' => 'video/quicktime', 'foundFileType' => 'mov'),
      array('mimeType' => 'video/avi', 'fileType' => 'avi',
            'foundMimeType' => 'video/avi', 'foundFileType' => 'avi'),
      array('mimeType' => 'audio/wav', 'fileType' => 'wav',
            'foundMimeType' => 'audio/wav', 'foundFileType' => 'wav'),
      array('mimeType' => 'audio/mpg', 'fileType' => 'mpg',
            'foundMimeType' => 'audio/mpeg', 'foundFileType' => 'mpeg'),
      array('mimeType' => 'audio/mpeg', 'fileType' => 'mpeg',
            'foundMimeType' => 'audio/mpeg', 'foundFileType' => 'mpeg'),
      array('mimeType' => 'audio/mpeg3', 'fileType' => 'mpeg3',
            'foundMimeType' => 'audio/mpeg3', 'foundFileType' => 'mpeg3'),
      array('mimeType' => 'audio/mpg3', 'fileType' => 'mpg3',
            'foundMimeType' => 'audio/mpeg3', 'foundFileType' => 'mpeg3'),
      array('mimeType' => 'audio/mp3', 'fileType' => 'mp3',
            'foundMimeType' => 'audio/mpeg3', 'foundFileType' => 'mpeg3'),
      array('mimeType' => 'audio/mpeg4', 'fileType' => 'mpeg4',
            'foundMimeType' => 'audio/mpeg4', 'foundFileType' => 'mpeg4'),
      array('mimeType' => 'audio/mpg4', 'fileType' => 'mpg4',
            'foundMimeType' => 'audio/mpeg4', 'foundFileType' => 'mpeg4'),
      array('mimeType' => 'audio/mp4', 'fileType' => 'mp4',
            'foundMimeType' => 'audio/mpeg4', 'foundFileType' => 'mpeg4')
      );
  }
