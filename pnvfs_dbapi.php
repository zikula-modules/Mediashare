<?php
// $Id: pnvfs_dbapi.php,v 1.4 2007/06/24 14:05:44 jornlind Exp $
// =======================================================================
...
WHERE     db.$mediadbColumn[fileref] = '$fileref'";
  ...
  $info = array('data' => $result->fields[0],
                'mimeType' => $result->fields[1],
                'bytes' => $result->fields[2],
                'mediaId' => $result->fields[3],
                'albumId' => $result->fields[4],
                'title' => $result->fields[5],
                'modifiedDate' => $result->fields[6]);
