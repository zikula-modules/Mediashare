...
class mediashare_realHandler
{
    ...
    {
        return array(
            array('mimeType' => 'application/vnd.rn-realmedia', 'fileType' => 'rm', 'foundMimeType' => 'application/vnd.rn-realmedia', 'foundFileType' => 'rm'),
            array('mimeType' => 'video/vnd.rn-realvideo', 'fileType' => 'rv', 'foundMimeType' => 'video/vnd.rn-realvideo', 'foundFileType' => 'rv'),
            array('mimeType' => 'audio/x-pn-realaudio', 'fileType' => 'ra', 'foundMimeType' => 'audio/x-pn-realaudio', 'foundFileType' => 'ra'));
    }
    ...
    function createPreviews($args, $previews)
    {
        ...
        foreach ($previews as $preview) {
            if ($preview['isThumbnail']) {
                ...
                $result[] = array('fileType' => $mediaFileType, 'mimeType' => $mimeType, 'width' => $width, 'height' => $height, 'bytes' => filesize($preview['outputFilename']));
            }
        }
