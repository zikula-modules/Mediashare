...
class MediashareFlickrAlbum extends MediashareBaseAlbum
{
    ...
    function convertImage(&$image)
    {
        ...
        $image = array(
            ...
            'title' => mb_convert_encoding($image['title'], __('ISO-8859-1', $dom), 'UTF-8'),
            'keywordsArray' => array(),
            'hasKeywords' => false,
            'keywords' => null,
            'description' => '',
            'caption' => mb_convert_encoding($image['title'], __('ISO-8859-1', $dom), 'UTF-8'),
            'captionLong' => mb_convert_encoding($image['title'], __('ISO-8859-1', $dom), 'UTF-8'),
